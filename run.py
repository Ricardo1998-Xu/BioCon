...
from transformers import (get_linear_schedule_with_warmup, AutoConfig,AutoModelForSequenceClassification,
                          AutoTokenizer,RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer,
                          T5Config, T5ForConditionalGeneration,CodeGenConfig, CodeGenModel)
...
def train(args, train_dataset, model, tokenizer):
    ...
    for idx in range(args.start_epoch, int(args.num_train_epochs)): 
        ...
        train_f1 = f1_score(train_labels, preds, average="macro")
        logger.info("  train f1:%s", round(train_f1, 4))
        ...
        tb_writer.add_scalar("train_f1", train_f1, idx)
...
def main():
    ...
    parser.add_argument('--num_labels', type=int, default=2,
                        help='class num')
    parser.add_argument("--train_data_file", default='./data/BioCon/train.jsonl', type=str,
                        help="The input training data file (a text file).")
    parser.add_argument("--eval_data_file", default='./data/BioCon/valid.jsonl', type=str,
                        help="An optional input evaluation data file to evaluate the perplexity on (a text file).")

    parser.add_argument("--output_dir", default='./weights/codebert/FL-weight=5-lr0.00002-seed1', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument('--runs_path', type=str, default='./runs/codebert/FL-weight=5-lr0.00002-seed1',
                        help='save runs path')
