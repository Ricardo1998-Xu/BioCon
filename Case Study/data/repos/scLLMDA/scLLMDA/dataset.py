...
def atac_data_graph_construction(data_path, train_name_list, test_name, sample_ratio, edge_ratio, label_name, save_path, save_unknown, save_rare, no_smote):
    ...
    #margin = adata_train.shape[0]
    #print("train")
    #print(adata_train.shape[0])
    #print("test")
    #print(adata_test.shape[0])
...
def ATAC_Dataset(data_path, train_name_list, test_name, sample_ratio, edge_ratio, label_name, save_path, le, save_unknown, save_rare, no_smote):
        ...
        return edge_index, node_feat, label, num_nodes, train_mask, val_mask, test_mask, adata, adata_train.shape[0], adata_test.shape[0], label_mapping
...
def load_ATAC_dataset(data_dir, train_name, test_name, sample_ratio, edge_ratio, save_path, save_unknown, save_rare, no_smote, label_name='CellType'):
    ...
    edge_index, node_feat, label, num_nodes, train_mask, val_mask, test_mask, adata, train_shape, test_shape, label_mapping = ATAC_Dataset(data_dir, train_name, test_name, sample_ratio, edge_ratio, label_name, save_path, le, save_unknown, save_rare, no_smote)
    ...
    return dataset, adata, le, train_shape, test_shape, label_mapping
