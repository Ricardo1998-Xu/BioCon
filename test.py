...
from transformers import (WEIGHTS_NAME, get_linear_schedule_with_warmup,AutoConfig,AutoModelForSequenceClassification, AutoTokenizer,
                            T5Config, T5ForConditionalGeneration, RobertaConfig, RobertaForSequenceClassification,
                          RobertaTokenizer,CodeGenConfig, CodeGenModel)
...
def test(args, model, tokenizer):
    ...
    THRESHOLD = 0.5
    logits = (logits_score[:, 1] > THRESHOLD).astype(int)
...
def main():
    ...
    parser.add_argument("--test_data_file", default='./data/BioCon/test.jsonl', type=str,
    ...
    parser.add_argument('--results_path', type=str,
                        default='./results/UniXcoder/FL-weight=5-lr0.00002-seed{seed}', help='save results path')
